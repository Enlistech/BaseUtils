...
public class NativeTemplateStyle {
  ...
  public static class Builder {
    ...
    private com.nativeads.NativeTemplateStyle styles;

    public Builder() {
      this.styles = new com.nativeads.NativeTemplateStyle();
    }
    ...
    public com.nativeads.NativeTemplateStyle build() {
      return styles;
    }
  }
}
